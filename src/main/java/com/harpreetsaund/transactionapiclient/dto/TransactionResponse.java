...
@Schema(name = "TransactionResponse", description = "Response object containing complete transaction details")
public class TransactionResponse {
    ...
    /**
     * Version 1 - Transaction Response Schema with Swagger documentation and
     * validation constraints
     */
    @Schema(name = "TransactionResponseVersion1", description = "Response object containing complete transaction details (Version 1)", example = "{\"id\":1,\"eventId\":\"evt-12345\",\"transactionId\":\"txn-98765\",\"accountNumber\":\"ACC-001\",\"transactionType\":\"DEBIT\",\"amount\":100.50,\"currency\":\"USD\",\"merchantName\":\"Sample Merchant\",\"channel\":\"ATM\",\"transactionTimestamp\":\"2026-03-10T10:30:00Z\",\"sourceSystem\":\"CORE\",\"topicName\":\"transaction-events\",\"createdAt\":\"2026-03-10T10:35:00Z\"}")
    public static class Version1 {

        @Schema(description = "System-generated unique transaction identifier", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @Schema(description = "System timestamp when the record was created", example = "2026-03-10T10:35:00Z", requiredMode = Schema.RequiredMode.REQUIRED)
